 ...
 */
function ensureContrast(fg, bg, minContrast = 4.5) {
    let adjusted = fg;
 ...
 */
function adjustForBackground(color, bg) {
    const bgIsLight = isLightColor(bg);
...
function createAlphaValues(isDark) {
...
exports.default = (colors, bordered) => {
    ...
    const contrastFg = isDark ? semantic.bg : (0, color_1.default)('#ffffff');
    return {
        type: themeType,
        ...
        colors: {
            ...
            'textLink.activeForeground': (isDark
                ...
                : semantic.accent.darken(0.1)).hex(),
            ...
            'button.secondaryHoverBackground': (isDark
                ...
                : semantic.bgHighlight.darken(0.05)).hex(),
            // ================================================================
            // Dropdown
            // ================================================================
